...
*Helping make the internet more private and secure.*

> Seeking internships in IT, networking, or cybersecurity

## Featured Project

### [CyberToys](https://github.com/johnarp/cybertoys)
...
- **Networking/Security:** Cisco IOS, Kali Linux, Windows Server, Wireshark
- **Programming:** Bash, JavaScript, Python
- **Cloud/Infra:** AWS, Azure, Docker, Vercel
